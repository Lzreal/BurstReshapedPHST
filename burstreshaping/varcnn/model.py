...
def get_model(config, mixture_num, calss_num):
    ...
    print(use_dir,use_time,use_metadata)
    ...
    model_checkpoint = ModelCheckpoint('model_weights.h5', monitor='val_accuracy',
                                       save_best_only=True,
